...
- **Results archive** (`/weatherboard/history`, added 2026-09-08): a day-by-day
  ...
  started or finished game is the score frozen at first pitch** (since
  2026-09-24) and is labeled **First pitch** for the same reason (see
  `game-wes-snapshot.ts`). The records are written hourly by
