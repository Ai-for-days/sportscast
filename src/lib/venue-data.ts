...
export const venues: Venue[] = [
  ...
  { id: 'ncaa-notredame', name: 'Notre Dame Stadium', team: 'Notre Dame Fighting Irish', sport: 'football', lat: 41.6985, lon: -86.2340, city: 'Notre Dame', state: 'IN', capacity: 77622, type: 'outdoor', league: 'ncaa-football', conference: 'Independent', division: 'Independent' },
  ...
  { id: 'ncaa-txstate', name: 'Bobcat Stadium', team: 'Texas State Bobcats', sport: 'football', lat: 29.8894, lon: -97.9400, city: 'San Marcos', state: 'TX', capacity: 30000, type: 'outdoor', league: 'ncaa-football', conference: 'Pac-12', division: 'Pac-12' },
  ...
  // Mountain West
  { id: 'ncaa-boise', name: 'Albertsons Stadium', team: 'Boise State Broncos', sport: 'football', lat: 43.6026, lon: -116.1955, city: 'Boise', state: 'ID', capacity: 36387, type: 'outdoor', league: 'ncaa-football', conference: 'Pac-12', division: 'Pac-12' },
  { id: 'ncaa-colorado-st', name: 'Canvas Stadium', team: 'Colorado State Rams', sport: 'football', lat: 40.5762, lon: -105.0848, city: 'Fort Collins', state: 'CO', capacity: 36500, type: 'outdoor', league: 'ncaa-football', conference: 'Pac-12', division: 'Pac-12' },
  ...
  { id: 'ncaa-utah-st', name: 'Maverik Stadium', team: 'Utah State Aggies', sport: 'football', lat: 41.7511, lon: -111.8128, city: 'Logan', state: 'UT', capacity: 25100, type: 'outdoor', league: 'ncaa-football', conference: 'Pac-12', division: 'Pac-12' },
  { id: 'ncaa-sdsu', name: 'Snapdragon Stadium (SDSU)', team: 'San Diego State Aztecs', sport: 'football', lat: 32.7829, lon: -117.1198, city: 'San Diego', state: 'CA', capacity: 35000, type: 'outdoor', league: 'ncaa-football', conference: 'Pac-12', division: 'Pac-12' },
  { id: 'ncaa-fresno-st', name: 'Valley Children\'s Stadium', team: 'Fresno State Bulldogs', sport: 'football', lat: 36.8143, lon: -119.7532, city: 'Fresno', state: 'CA', capacity: 40727, type: 'outdoor', league: 'ncaa-football', conference: 'Pac-12', division: 'Pac-12' },
  ...
  { id: 'ncaa-latech', name: 'Joe Aillet Stadium', team: 'Louisiana Tech Bulldogs', sport: 'football', lat: 32.5336, lon: -92.6516, city: 'Ruston', state: 'LA', capacity: 28000, type: 'outdoor', league: 'ncaa-football', conference: 'Sun Belt', division: 'Sun Belt West' },
  ...
  { id: 'ncaa-uab', name: 'Protective Stadium', team: 'UAB Blazers', sport: 'football', lat: 33.5151, lon: -86.8030, city: 'Birmingham', state: 'AL', capacity: 47100, type: 'outdoor', league: 'ncaa-football', conference: 'AAC', division: 'AAC' },
  { id: 'ncaa-charlotte', name: 'Jerry Richardson Stadium', team: 'Charlotte 49ers', sport: 'football', lat: 35.3094, lon: -80.7406, city: 'Charlotte', state: 'NC', capacity: 15314, type: 'outdoor', league: 'ncaa-football', conference: 'AAC', division: 'AAC' },
  { id: 'ncaa-utep', name: 'Sun Bowl Stadium', team: 'UTEP Miners', sport: 'football', lat: 31.7733, lon: -106.5128, city: 'El Paso', state: 'TX', capacity: 46670, type: 'outdoor', league: 'ncaa-football', conference: 'Mountain West', division: 'Mountain West' },
  { id: 'ncaa-nmsu', name: 'Aggie Memorial Stadium', team: 'New Mexico State Aggies', sport: 'football', lat: 32.2828, lon: -106.7460, city: 'Las Cruces', state: 'NM', capacity: 30343, type: 'outdoor', league: 'ncaa-football', conference: 'C-USA', division: 'C-USA' },
  ...
  { id: 'ncaa-ballst', name: 'Scheumann Stadium', team: 'Ball State Cardinals', sport: 'football', lat: 40.2010, lon: -85.4116, city: 'Muncie', state: 'IN', capacity: 22500, type: 'outdoor', league: 'ncaa-football', conference: 'MAC', division: 'MAC West' },
  { id: 'ncaa-bgsu', name: 'Doyt Perry Stadium', team: 'Bowling Green Falcons', sport: 'football', lat: 41.3793, lon: -83.6379, city: 'Bowling Green', state: 'OH', capacity: 24000, type: 'outdoor', league: 'ncaa-football', conference: 'MAC', division: 'MAC East' },
  { id: 'ncaa-buffalo', name: 'UB Stadium', team: 'Buffalo Bulls', sport: 'football', lat: 43.0017, lon: -78.7857, city: 'Amherst', state: 'NY', capacity: 30000, type: 'outdoor', league: 'ncaa-football', conference: 'MAC', division: 'MAC East' },
  { id: 'ncaa-cmich', name: 'Kelly/Shorts Stadium', team: 'Central Michigan Chippewas', sport: 'football', lat: 43.5818, lon: -84.7780, city: 'Mount Pleasant', state: 'MI', capacity: 30255, type: 'outdoor', league: 'ncaa-football', conference: 'MAC', division: 'MAC West' },
  { id: 'ncaa-emich', name: 'Rynearson Stadium', team: 'Eastern Michigan Eagles', sport: 'football', lat: 42.2334, lon: -83.6262, city: 'Ypsilanti', state: 'MI', capacity: 30200, type: 'outdoor', league: 'ncaa-football', conference: 'MAC', division: 'MAC West' },
  { id: 'ncaa-kentst', name: 'Dix Stadium', team: 'Kent State Golden Flashes', sport: 'football', lat: 41.1607, lon: -81.3415, city: 'Kent', state: 'OH', capacity: 25000, type: 'outdoor', league: 'ncaa-football', conference: 'MAC', division: 'MAC East' },
  { id: 'ncaa-miamioh', name: 'Yager Stadium', team: 'Miami (OH) RedHawks', sport: 'football', lat: 39.5085, lon: -84.7332, city: 'Oxford', state: 'OH', capacity: 24286, type: 'outdoor', league: 'ncaa-football', conference: 'MAC', division: 'MAC East' },
  { id: 'ncaa-niu', name: 'Huskie Stadium', team: 'Northern Illinois Huskies', sport: 'football', lat: 41.9355, lon: -88.7715, city: 'DeKalb', state: 'IL', capacity: 24000, type: 'outdoor', league: 'ncaa-football', conference: 'Mountain West', division: 'Mountain West' },
  { id: 'ncaa-ohio', name: 'Peden Stadium', team: 'Ohio Bobcats', sport: 'football', lat: 39.3270, lon: -82.0943, city: 'Athens', state: 'OH', capacity: 24000, type: 'outdoor', league: 'ncaa-football', conference: 'MAC', division: 'MAC East' },
  ...
  { id: 'ncaa-sacst', name: 'Hornet Stadium', team: 'Sacramento State Hornets', sport: 'football', lat: 38.5556, lon: -121.4244, city: 'Sacramento', state: 'CA', capacity: 21195, type: 'outdoor', league: 'ncaa-football', conference: 'MAC', division: 'MAC West' },
  ...
  { id: 'mls-sdfc', name: 'Snapdragon Stadium (San Diego FC)', team: 'San Diego FC', sport: 'soccer', lat: 32.7829, lon: -117.1198, city: 'San Diego', state: 'CA', capacity: 32500, type: 'outdoor', league: 'mls', conference: 'Western', division: 'Western' },
  ...
  { id: 'nwsl-thorns', name: 'Providence Park (Thorns)', team: 'Portland Thorns FC', sport: 'soccer', lat: 45.5215, lon: -122.6916, city: 'Portland', state: 'OR', capacity: 25218, type: 'outdoor', league: 'mls', conference: 'Other', division: 'NWSL' },
  { id: 'nwsl-spirit', name: 'Audi Field (Spirit)', team: 'Washington Spirit', sport: 'soccer', lat: 38.8686, lon: -77.0128, city: 'Washington', state: 'DC', capacity: 20000, type: 'outdoor', league: 'mls', conference: 'Other', division: 'NWSL' },
  { id: 'nwsl-current', name: 'CPKC Stadium', team: 'Kansas City Current', sport: 'soccer', lat: 39.1031, lon: -94.5841, city: 'Kansas City', state: 'MO', capacity: 11500, type: 'outdoor', league: 'mls', conference: 'Other', division: 'NWSL' },
  { id: 'nwsl-angel', name: 'BMO Stadium (Angel City)', team: 'Angel City FC', sport: 'soccer', lat: 34.0128, lon: -118.2843, city: 'Los Angeles', state: 'CA', capacity: 22000, type: 'outdoor', league: 'mls', conference: 'Other', division: 'NWSL' },
  { id: 'nwsl-gotham', name: 'Sports Illustrated Stadium', team: 'NJ/NY Gotham FC', sport: 'soccer', lat: 40.7368, lon: -74.1503, city: 'Harrison', state: 'NJ', capacity: 25000, type: 'outdoor', league: 'mls', conference: 'Other', division: 'NWSL' },
  { id: 'nwsl-pride', name: 'Inter&Co Stadium (Pride)', team: 'Orlando Pride', sport: 'soccer', lat: 28.5411, lon: -81.3892, city: 'Orlando', state: 'FL', capacity: 25500, type: 'outdoor', league: 'mls', conference: 'Other', division: 'NWSL' },
  { id: 'nwsl-reign', name: 'Lumen Field (Reign)', team: 'Seattle Reign FC', sport: 'soccer', lat: 47.5952, lon: -122.3316, city: 'Seattle', state: 'WA', capacity: 37722, type: 'outdoor', league: 'mls', conference: 'Other', division: 'NWSL' },
  { id: 'nwsl-bay', name: 'PayPal Park (Bay FC)', team: 'Bay FC', sport: 'soccer', lat: 37.3517, lon: -121.9250, city: 'San Jose', state: 'CA', capacity: 18000, type: 'outdoor', league: 'mls', conference: 'Other', division: 'NWSL' },
  { id: 'nwsl-utah', name: 'America First Field (Utah Royals)', team: 'Utah Royals FC', sport: 'soccer', lat: 40.5830, lon: -111.8933, city: 'Sandy', state: 'UT', capacity: 20213, type: 'outdoor', league: 'mls', conference: 'Other', division: 'NWSL' },
  { id: 'nwsl-houston', name: 'Shell Energy Stadium (Dash)', team: 'Houston Dash', sport: 'soccer', lat: 29.7522, lon: -95.3524, city: 'Houston', state: 'TX', capacity: 22039, type: 'outdoor', league: 'mls', conference: 'Other', division: 'NWSL' },
  { id: 'nwsl-chicago', name: 'SeatGeek Stadium', team: 'Chicago Stars FC', sport: 'soccer', lat: 41.7232, lon: -87.7505, city: 'Bridgeview', state: 'IL', capacity: 20000, type: 'outdoor', league: 'mls', conference: 'Other', division: 'NWSL' },
  { id: 'nwsl-louisville', name: 'Lynn Family Stadium', team: 'Racing Louisville FC', sport: 'soccer', lat: 38.2625, lon: -85.7397, city: 'Louisville', state: 'KY', capacity: 11700, type: 'outdoor', league: 'mls', conference: 'Other', division: 'NWSL' },
