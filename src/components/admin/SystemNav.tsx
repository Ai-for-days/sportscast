...
const SECTIONS: NavSection[] = [
  {
    ...
    items: [
      ...
      { href: '/admin/system/strategy-brief',         title: 'Strategy Brief',      description: 'Daily desk briefing + scorecard alerts (open / acknowledged / resolved)', badge: 'NEW', badgeColor: 'bg-indigo-100 text-indigo-700' },
