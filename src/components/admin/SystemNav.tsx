...
const SECTIONS: NavSection[] = [
  {
    ...
    items: [
      ...
      { href: '/admin/system/strategy-scorecard',     title: 'Strategy Scorecard',  description: 'Executive command view: 5 health scores, top actions, and the full lifecycle funnel', badge: 'NEW', badgeColor: 'bg-indigo-100 text-indigo-700' },
