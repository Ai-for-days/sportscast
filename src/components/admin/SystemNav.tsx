...
const SECTIONS: NavSection[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { href: '/admin/system/audit-investigation',   title: 'Audit Investigation', description: 'Read-only timeline reconstruction across wagers / disputes / incidents / integrity / governance — saved views with notes', badge: 'NEW', badgeColor: 'bg-indigo-100 text-indigo-700' },
