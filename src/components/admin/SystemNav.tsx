...
const SECTIONS: NavSection[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { href: '/admin/system/weather-evidence',      title: 'Weather Evidence',   description: 'Manual multi-source weather observations with consensus / spread / verdict (advisory only — does not grade)', badge: 'NEW', badgeColor: 'bg-indigo-100 text-indigo-700' },
