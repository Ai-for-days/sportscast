...
const SECTIONS: NavSection[] = [
  {
    ...
    items: [
      ...
      { href: '/admin/system/desk-queue',             title: 'Desk Queue',          description: 'Prioritized, time-aware action queue across scorecard / alerts / decisions / pilots', badge: 'NEW', badgeColor: 'bg-indigo-100 text-indigo-700' },
