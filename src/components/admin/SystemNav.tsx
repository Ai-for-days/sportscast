...
const SECTIONS: NavSection[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { href: '/admin/system/daily-operator-runbook', title: 'Daily Runbook', description: 'One-per-day operating checklist across creation / monitoring / resolution / governance / safety (recordkeeping only)', badge: 'NEW', badgeColor: 'bg-indigo-100 text-indigo-700' },
