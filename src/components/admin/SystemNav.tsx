...
const SECTIONS: NavSection[] = [
  {
    ...
    items: [
      ...
      { href: '/admin/system/operator-training',      title: 'Operator Training',   description: 'Sandboxed practice scenarios with mock data + scoring rubric', badge: 'NEW', badgeColor: 'bg-indigo-100 text-indigo-700' },
