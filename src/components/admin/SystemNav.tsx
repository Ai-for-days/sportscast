...
const SECTIONS: NavSection[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { href: '/admin/system/crypto-paper-portfolio', title: 'Crypto Paper Portfolio', description: 'Side-effect-free $100,000 paper bankroll for crypto signals. No exchange APIs, no wallets, no real funds. Research-only ledger + risk gates.', badge: 'NEW', badgeColor: 'bg-purple-100 text-purple-700' },
      { href: '/admin/system/crypto-paper-alert-preview', title: 'Crypto Alert Preview', description: 'HTML + plaintext preview of the latest simulated paper-trade alert. Preview-only — no mailer wired up.', badge: 'NEW', badgeColor: 'bg-purple-100 text-purple-700' },
