...
const SECTIONS: NavSection[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { href: '/admin/system/house-exposure',        title: 'House Exposure',     description: 'Read-only financial exposure & PnL: projected worst case, realized graded results, market + user concentration', badge: 'NEW', badgeColor: 'bg-indigo-100 text-indigo-700' },
