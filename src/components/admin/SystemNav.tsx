...
const SECTIONS: NavSection[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { href: '/admin/system/user-risk-monitoring',  title: 'User Risk',          description: 'Advisory responsible-play and integrity signals per user (no bans, no limits, no notifications)', badge: 'NEW', badgeColor: 'bg-indigo-100 text-indigo-700' },
