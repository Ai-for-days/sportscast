...
const SECTIONS: NavSection[] = [
  {
    ...
    items: [
      ...
      { href: '/admin/system/operator-certification', title: 'Operator Certification', description: 'Readiness verdicts + manual certification ledger (advisory only — no RBAC changes)', badge: 'NEW', badgeColor: 'bg-indigo-100 text-indigo-700' },
