...
const SECTIONS: NavSection[] = [
  ...
  },
  {
    ...
    items: [
      { href: '/admin/system/command-center',   title: 'Command Center',     description: 'Top-level system map: overview, workflow, tool directory, current status, safety model, what to do next', badge: 'NEW', badgeColor: 'bg-indigo-100 text-indigo-700' },
