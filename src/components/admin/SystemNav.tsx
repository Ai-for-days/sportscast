...
const SECTIONS: NavSection[] = [
  {
    ...
    items: [
      ...
      { href: '/admin/system/playbook-audit',         title: 'Playbook Audit',      description: 'Compliance + execution-quality audit over manual playbook runs', badge: 'NEW', badgeColor: 'bg-indigo-100 text-indigo-700' },
