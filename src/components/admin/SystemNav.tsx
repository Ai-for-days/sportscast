...
export const SECTIONS: NavSection[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { href: '/admin/system/wager-schedule', title: 'Wager Schedule', description: 'All-sports schedule (MLB/NFL/NCAA Football/MLS) for one date, with rotation numbers and Wager on Weather\'s daily high/low forecast at each venue — create a wager directly from any game.', badge: 'NEW', badgeColor: 'bg-rose-100 text-rose-700' },
  ...
  },
  {
    ...
    items: [
      ...
      { href: '/admin/system/roof-status',        title: 'Roof Status',       description: 'Manual open/closed override for retractable-roof venues with no live roof API (everything except MLB).' },
