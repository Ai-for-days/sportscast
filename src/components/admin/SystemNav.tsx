...
const SECTIONS: NavSection[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { href: '/admin/system/operational-health',    title: 'Operational Health', description: 'Subsystem status, stale data, workflow backlogs, API failures, Redis health — advisory snapshots only', badge: 'NEW', badgeColor: 'bg-indigo-100 text-indigo-700' },
