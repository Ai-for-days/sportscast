...
const SECTIONS: NavSection[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { href: '/admin/system/dispute-workflow',      title: 'Disputes',           description: 'Document, investigate, recommend, and resolve disputed outcomes (advisory recommendations — no auto-regrade)', badge: 'NEW', badgeColor: 'bg-indigo-100 text-indigo-700' },
