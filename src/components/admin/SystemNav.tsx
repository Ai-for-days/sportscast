...
const SECTIONS: NavSection[] = [
  {
    ...
    items: [
      ...
      { href: '/admin/system/operator-rbac-review',   title: 'RBAC Review',         description: 'Advisory governance: certification status vs current RBAC access (no permission changes)', badge: 'NEW', badgeColor: 'bg-indigo-100 text-indigo-700' },
  ...
  },
  {
    ...
    items: [
      ...
      { href: '/admin/system/wager-change-control',  title: 'Change Control',     description: 'Approve and document proposed wager changes (odds / line / void / regrade / settlement review). Approval only — implementation is manual.', badge: 'NEW', badgeColor: 'bg-indigo-100 text-indigo-700' },
