...
const SECTIONS: NavSection[] = [
  {
    ...
    items: [
      ...
      { href: '/admin/system/execution-playbook',     title: 'Execution Playbook',  description: 'Manual checklist: signal → risk → pilot → approval → execution → post-trade', badge: 'NEW', badgeColor: 'bg-indigo-100 text-indigo-700' },
