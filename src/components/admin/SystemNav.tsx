...
const SECTIONS: NavSection[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { href: '/admin/system/weather-market-quality-inspector', title: 'Quality Inspector', description: 'Admin-only audit of the Step 163 opportunity-quality pipeline — confidence, score, dedupe cluster, suppression reason per idea.', badge: 'NEW', badgeColor: 'bg-teal-100 text-teal-700' },
