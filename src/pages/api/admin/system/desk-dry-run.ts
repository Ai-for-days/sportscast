...
const STEPS = [
  ...
  { stage: 'Forecasting', key: 'consensus_compute', title: 'Compute Wager on Weather Forecast', description: 'Verify the forecast blending step produces output from multiple sources.', successCriteria: 'Records visible in forecasts or forecast-blend views.' },
